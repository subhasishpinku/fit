                  ...
                  child: SingleChildScrollView(
                    child: Column(
                      ...
                      children: [
                        ...
                        ...List.generate(vm.history.length, (index) {
                          ...
                          return Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              // Add separator between different history entries
                              if (index > 0) ...[
                              ...
                              // Header with Track number and date
                              Row(
                                mainAxisAlignment:
