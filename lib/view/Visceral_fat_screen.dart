...
class VisceralFatScreen extends StatefulWidget {
  const VisceralFatScreen({super.key});

  @override
  State<VisceralFatScreen> createState() => _VisceralFatScreenState();
}

class _VisceralFatScreenState extends State<VisceralFatScreen> {
  @override
  void initState() {
    super.initState();
  ...
  Widget build(BuildContext context) {
    final viewModel = context.watch<VisceralFatViewModel>();
                ...
                child: Column(
                  ...
                  children: [
                    const Padding(
                      ...
                      child: Text(
                        "Enter your current visceral fat",
                        style: TextStyle(
                          fontSize: 15,
                          color: Colors.black,
                      ...
                      child: Container(
                        ...
                        child: TextField(
                          ...
                          decoration: const InputDecoration(
                            hintText: "Enter visceral fat value Only",
