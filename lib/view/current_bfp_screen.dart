...
class CurrentBfpScreen extends StatelessWidget {
  const CurrentBfpScreen({super.key});

  @override
  Widget build(BuildContext context) {
    return ChangeNotifierProvider(
      create: (_) => CurrentBFPViewModel(),
      child: const _CurrentBfpScreenBody(),
    );
  }
}

class _CurrentBfpScreenBody extends StatelessWidget {
  const _CurrentBfpScreenBody();
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Expanded(
                  child: Consumer<CurrentBFPViewModel>(
                        ...
                        child: GridView.builder(
                          ...
                          itemBuilder: (context, index) {
                            ...
                            return GestureDetector(
                              onTap: () {
                                viewModel.selectIndex(index,context);
                                Navigator.pushNamed(
                                  context,
