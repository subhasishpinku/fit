...
class SigninScreenEight extends StatelessWidget {
  const SigninScreenEight({super.key});

  @override
  Widget build(BuildContext context) {
    return ChangeNotifierProvider(
      create: (_) => SigninEightViewModel(),
      child: const _SigninScreenEightBody(),
    );
  }
}

class _SigninScreenEightBody extends StatelessWidget {
  const _SigninScreenEightBody();

  @override
  Widget build(BuildContext context) {
    final provider = Provider.of<SigninEightViewModel>(context);
                  ...
                  child: Center(
                    child: ListWheelScrollView.useDelegate(
                      ...
                      onSelectedItemChanged: (index) {
                        provider.setSelectedWeight(weights[index]);
                      },
