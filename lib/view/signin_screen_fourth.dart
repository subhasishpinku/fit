...
class SigninScreenFourth extends StatefulWidget {
  const SigninScreenFourth({super.key});

  @override
  State<SigninScreenFourth> createState() => _SigninScreenFourthState();
}

class _SigninScreenFourthState extends State<SigninScreenFourth> {
  @override
  Widget build(BuildContext context) {
    final provider = Provider.of<SigninFourthViewModel>(context);
