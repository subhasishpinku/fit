...
class SkeletalMuscleScreen extends StatefulWidget {
  const SkeletalMuscleScreen({super.key});

  @override
  State<SkeletalMuscleScreen> createState() => _SkeletalMuscleScreenState();
}

class _SkeletalMuscleScreenState extends State<SkeletalMuscleScreen> {
  @override
  void initState() {
    super.initState();
                ...
                child: Column(
                  ...
                  children: [
                    const Padding(
                      ...
                      child: Text(
                        "Enter your current skeletal muscle mass today",
                        style: TextStyle(
                          fontSize: 15,
                          color: Colors.black,
