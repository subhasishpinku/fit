...
class SubcutaneousFatScreen extends StatefulWidget {
  const SubcutaneousFatScreen({super.key});

  @override
  State<SubcutaneousFatScreen> createState() => _SubcutaneousFatScreenState();
}

class _SubcutaneousFatScreenState extends State<SubcutaneousFatScreen> {
  @override
  void initState() {
    super.initState();
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) async {
      ...
      Provider.of<SubcutaneousFatViewModel>(
        context,
        listen: false,
      ).fetchWeightLogs(
        userId: userId,
  ...
  Widget build(BuildContext context) {
    final viewModel = context.watch<SubcutaneousFatViewModel>();
                ...
                child: Column(
                  ...
                  children: [
                    const Padding(
                      ...
                      child: Text(
                        "Enter today's subcutaneous fat",
                        style: TextStyle(
                          fontSize: 15,
                          color: Colors.black,
