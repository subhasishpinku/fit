...
class SigninSeventeenViewModel extends ChangeNotifier {
  ...
  Future<void> saveSelectedItems() async {
    ...
    await prefs.setString("grains", jsonString);
    String? grainsString = prefs.getString("grains");
    print("Saved Grain String: $grainsString"); // prints JSON string
  }
