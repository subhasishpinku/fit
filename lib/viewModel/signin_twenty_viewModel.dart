...
Future<void> fetchFoods({String? subCategory}) async {
  ...
  Future<void> saveSelectedItems() async {
    ...
    await prefs.setString("vegetables", jsonString);
    String? grainsString = prefs.getString("vegetables");
    print("Saved vegetables String: $grainsString"); // prints JSON string
  }
